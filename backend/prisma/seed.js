...
async function main() {
  ...
  const nvITManager = await prisma.nhanVien.create({
    data: {
      ...
      nhom_ho_tro_id: null,
      email: 'thangpq23406@st.uel.edu.vn',
      tai_khoan: 'thangpq23406',
      mat_khau: defaultHash,
      ho_ten: 'Thang Pham Quoc',
      trang_thai: true,
  ...
  const nvL1_1 = await prisma.nhanVien.create({
    data: {
      ...
      email: 'huyentld23406@st.uel.edu.vn',
      tai_khoan: 'huyentld23406',
      mat_khau: defaultHash,
  ...
  const nvL2_1 = await prisma.nhanVien.create({
    data: {
      ...
      email: 'vanbtt23406@st.uel.edu.vn',
      tai_khoan: 'vanbtt23406',
      mat_khau: defaultHash,
