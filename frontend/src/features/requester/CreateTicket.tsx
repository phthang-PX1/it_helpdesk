...
export const CreateTicket: React.FC = () => {
  ...
  useEffect(() => {
    // Tự động tải 3 bài viết xem nhiều nhất làm FAQ
    const loadFaqs = async () => {
      try {
        const res = await kbService.getAll({ limit: 3, sort: 'luot_xem', trang_thai: 'DA_XUAT_BAN' });
        if (res.data && res.data.length > 0) {
          setFaqs(res.data.map(a => ({
            question: a.tieu_de,
            answer: a.noi_dung
          })));
        }
          ...
          <div className="support-column">
            ...
            <div className="support-card">
              ...
              <div className="faq-list">
                ...
                {faqs.length === 0 && (
                  <div className="faq-item" style={{ padding: '16px', color: '#64748B', fontSize: '13px' }}>
